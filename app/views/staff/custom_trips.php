...
<section class="dashboard-section">
    ...
    <div class="page-head">
        ...
        <p>
            Review, approve/reject, and reply to customer customized travel requests
        </p>
    </div>
                ...
                <?php if (!empty($trips)): ?>
                    ...
                    <?php foreach ($trips as $trip): ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <?= !empty($trip['travel_date']) 
                                    ? date('M d, Y', strtotime($trip['travel_date'])) 
                                    : '-' ?>
                            </td>
                            ...
                            <td>
                                <strong>
                                    LKR <?= number_format((float)($trip['budget'] ?? 0), 2) ?>
                                </strong>
                            </td>
                            ...
                            <td>
                                ...
                                <?php elseif ($status === 'approved'): ?>
                                    ...
                                    <span class="trip-approved-badge">
                                        Approved Already
                                    </span>

                                <?php elseif ($status === 'rejected'): ?>

                                    <span class="trip-rejected-badge">
                                        Rejected Already
                                    </span>
