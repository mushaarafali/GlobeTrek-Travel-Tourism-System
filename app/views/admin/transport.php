...
<section class="admin-page">
    ...
    <div class="table-card admin-table-card"><h2>Transport Fleet</h2><table class="table"><tr><th>Vehicle</th><th>No</th><th>Seats</th><th>Price</th><th>Driver</th><th>Status</th><th>Action</th></tr>
        <?php foreach(($items ?? []) as $i): ?><tr><td><?= e($i['vehicle_type']) ?></td><td><?= e($i['vehicle_no']) ?></td><td><?= e($i['seats']) ?></td><td>LKR <?= number_format($i['price_per_day']) ?></td><td><?= e($i['driver_name']) ?> / <?= e($i['driver_phone']) ?></td><td><?= e($i['status']) ?></td><td><a class="table-link" href="<?= $editBase . e($i['id']) ?>">Edit</a> <a class="table-link danger" href="<?= $deleteBase . e($i['id']) ?>" onclick="return confirm('Delete transport?')">Delete</a></td></tr><?php endforeach; ?>
    </table></div>
</section>
